...
To use these stylesheets, rename the files and app_market with the name of your theme.
...
app_market-alpha-default-narrow.css  
...
app_market-alpha-default-normal.css
...
app_market-alpha-default-wide.css
